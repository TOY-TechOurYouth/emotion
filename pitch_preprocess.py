...
save_dir=r"C:\Users\ailab\PycharmProjects\toy\pitch_plot"

# 실제 wav 파일들이 있는 디렉토리 경로
base_audio_dir = r"C:\Users\ailab\PycharmProjects\toy\five_2"

# CSV에서 wav_id와 label(성별) 불러오기
df = pd.read_csv(r"C:\Users\ailab\PycharmProjects\toy\gender_only.csv")
...
# 결과 CSV로 저장
with open('pitch_gender_results.csv', 'w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
...
# 파일 이름 설정 후 저장
save_path = os.path.join(save_dir, f"pitch_plot_6.png")
